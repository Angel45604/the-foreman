...
### prepr round-1 amendments

What actually shipped after the pre-PR review (the two P1s were filed against the plan text above; this record reflects the as-built behavior):
